...
function handlePromptSubmit(event) {
  ...
  const hasRequiredValues = values.level && values.subject && values.topic && values.helpType;

  copyMessage.hidden = true;

  if (!hasRequiredValues) {
    showGeneratorMessage("দয়া করে লেভেল, বিষয়, টপিক এবং সাহায্যের ধরন নির্বাচন করুন।");
...
async function handleCopyPrompt() {
  ...
  copyMessage.textContent = "প্রম্পট কপি হয়েছে। এখন এটি ChatGPT বা অন্য এআই টুলে ব্যবহার করুন।";
